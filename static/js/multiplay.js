	...
	function initColors(getColorsResponse) {
	...
	function registerForMultiPlay() {
		...
		window.multiPlaySocket.onmessage = function (response) {
			...
			prepareSocketResponse(JSON.parse(response.data))
		}
	...
	var socketResponseHandlers = {}

	prepareSocketResponseHandlers();

	function prepareSocketResponseHandlers() {

		socketResponseHandlers["opponentMove"] = function (socketResponse) {
			debugger;
		}


		socketResponseHandlers["initialColors"] = function (socketResponse) {
			debugger;
		...
		socketResponseHandlers["info"] = function (socketResponse) {
			debugger;
	...
	function prepareSocketResponse(socketResponse) {
		var responseHandlerFunc = socketResponseHandlers[socketResponse.messageKey]

		responseHandlerFunc(socketResponse.messageData)
	}